package com.transmilenio.fuerzaoperativa.models.util;
...
public class Mensajes {
    ...
    public static String OPCION_USUARIO = "Usuarios";
    ...
    public static String MSG_CREAR_USUARIO = "Nuevo usuario";
    ...
    public static String MSG_ENCUESTAS_NO_ENVIADAS = "Encuestas No Enviadas";
    public static String MSG_RESULTADO_ENVIO = "Resultados del Envio";
